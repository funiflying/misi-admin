...
class app extends  React.Component{
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            if(values.upload){
                values.upload.fileList.map((file)=>{
                    params.product.picture.push(file.response)
                })
            }
    ...
    handleUpload(file){
        if(file.file&&file.file.status==='done'||file.file.status==='removed'){
            let items=[];
                    ...
                    <Col>
                        <Card title="商品规格" extra={<a href="javascript:void(0)" onClick={this.handleRemoveOffer.bind(this,k)}>删除</a>} key={k} style={{"margin":"10px auto"}}>
                            <FormItem
                                ...
                                label="规格"
                            >
                                {getFieldDecorator(`content${k}`, { initialValue: '',rules:[{
                            ...
                            <FormItem
                                ...
                                label="售价"
                            >
                                {getFieldDecorator(`price${k}`, { initialValue: '',rules:[{
                                    required:true,message:'名称必填'
                                }] })(
                                    <Input type="text" placeholder="" />
                                )}
                    ...
                    <Row>
                        <Col span={12}>
                            <FormItem
                                ...
                                label="名称"
                            >
                                {getFieldDecorator('product.name', { initialValue: '',rules:[{
                                    required:true,message:'名称必填'
                                }] })(
                                    <Input type="text" placeholder="" />
                                )}
