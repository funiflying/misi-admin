        ...
        return (
            <Form horizontal onSubmit={this.handleSubmit.bind(this)}>
                <FormItem
                    ...
                    label="名称"
                >
                    {getFieldDecorator('navigation.name', { initialValue: this.state.item.name,rules:[{
                        required:true,message:'名称必填'
                    }] })(
                        <Input type="text" placeholder="" />
                    )}
                    {getFieldDecorator('navigation._id', { initialValue: this.state.item._id })(
                        <Input type="hidden" />
                    )}
                </FormItem>
                <FormItem
                    ...
                    label="url"
                >
                    {getFieldDecorator('navigation.url', { initialValue: this.state.item.url,rules:[{
                ...
                >
                    {getFieldDecorator('navigation.menu', {
                        initialValue: this.state.item._mid,
                        rules:[{
